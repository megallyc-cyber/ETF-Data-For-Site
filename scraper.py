...
FUND_REGISTRY: list[Fund] = [
    ...
    Fund("AGCC", "Global X Silver Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/agcc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("BCCC", "Global X Bitcoin Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/bccc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("BCCL", "Global X Enhanced Bitcoin Covered Call ETF", "Global X Canada", "CAD",
    ...
    Fund("CPCC", "Global X Copper Producer Equity Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/cpcc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("HGY", "Global X Gold Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/hgy#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("LPAY", "Global X Long-Term U.S. Treasury Premium Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/lpay#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("MPAY", "Global X Mid-Term U.S. Treasury Premium Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/mpay#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("PAYL", "Global X Long-Term Government Bond Premium Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/payl#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("PAYM", "Global X Mid-Term Government Bond Premium Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/paym#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("PAYS", "Global X Short-Term Government Bond Premium Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/pays#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("QQCC", "Global X Nasdaq-100 Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/qqcc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("QQCL", "Global X Enhanced Nasdaq-100 Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/qqcl#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("RNCC", "Global X Equal Weight Canadian Telecommunications Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/rncc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("RNCL", "Global X Enhanced Equal Weight Canadian Telecommunications Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/rncl#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("RSCC", "Global X Russell 2000 Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/rscc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("RSCL", "Global X Enhanced Russell 2000 Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/rscl#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("SPAY", "Global X Short-Term U.S. Treasury Premium Yield ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/spay#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("SVCC", "Global X Silver Miners Covered Call ETF", "Global X Canada", "CAD",
    ...
    Fund("URCC", "Global X Uranium Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/urcc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("USCC", "Global X S&P 500 Covered Call ETF", "Global X Canada", "CAD",
                  "https://www.globalx.ca/product/uscc#holdings", "globalx_ca_rendered", needs_browser=True),
    Fund("USCL", "Global X Enhanced S&P 500 Covered Call ETF", "Global X Canada", "CAD",
